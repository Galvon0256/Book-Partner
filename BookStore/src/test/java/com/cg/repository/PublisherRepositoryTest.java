 ...
 *              DDL: create-drop — seed data via import.sql is required before
 *              tests run.
 *              findAll() is never called without a Pageable to avoid full-table
 *              scans.
 *
 *              NOTE: publishers_chk_1 constraint on pub_id — only 4-digit
 *              numeric strings
 *              are accepted (e.g. "9998", "9999"). Alpha/alphanumeric IDs like
 *              "RP01"
...
class PublisherRepositoryTest {
    ...
    /**
     * Success: first page (page=0, size=5) has the correct page number and bounded
     * content.
     */
    @Test
    ...
    /**
     * Success: new publisher is saved and immediately retrievable within the same
     * tx.
     */
    @Test
