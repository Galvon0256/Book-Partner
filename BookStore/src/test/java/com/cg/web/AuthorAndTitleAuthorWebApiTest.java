...
class AuthorAndTitleAuthorWebApiTest {
        ...
        void postTitleAuthor_afterCreate_resourceIsRetrievable() throws Exception {
                ...
                mockMvc.perform(get("/api/titleauthors/search/findByAuId").param("auId", "238-95-7766"))
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$._embedded.titleauthors[*].auId", hasItem("238-95-7766")))
                                .andExpect(jsonPath("$._embedded.titleauthors[*].titleId", hasItem("PC8888")))
                                .andExpect(jsonPath("$._embedded.titleauthors[*].royaltyper", hasItem(30)));
        }
